...
def watchmenAlarm():
    ...
    event = FmEvent(True, source_one, 193, 2032707, enums.FM_ACTIVE_SEVERITY.MAJOR, enums.FM_EVENT_TYPE.equipmentAlarm,
...
#Tenant=689c319ac7a14aca86312c3e1036b275,VM=1693537f-98f4-4e5b-b425-a5075189fd37